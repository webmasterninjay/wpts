...
add_action( 'wp_enqueue_scripts', 'wpts_custom_gutenberg_css' );
/**
 * Outputs front-end inline styles based on colors declared in config/appearance.php.
 *
 * @since 2.9.0
 */
function wpts_custom_gutenberg_css() {
...
CSS;
	...
	$css .= wpts_inline_font_sizes();
	$css .= wpts_inline_color_palette();

	wp_add_inline_style( genesis_get_theme_handle() . '-gutenberg', $css );

}

add_action( 'enqueue_block_editor_assets', 'wpts_custom_gutenberg_admin_css' );
/**
 ...
 * @since 2.9.0
 */
function wpts_custom_gutenberg_admin_css() {
...
CSS;
	...
	$css .= wpts_editor_inline_color_palette();
 ...
 */
function wpts_inline_font_sizes() {
 ...
 */
function wpts_inline_color_palette() {
 ...
 * @return string The editor colors CSS if `editor-color-palette` theme support was declared.
 */
function wpts_editor_inline_color_palette() {
