 ...
 * Wpts.
 *
 * This file adds the required WooCommerce setup functions to the Wpts Theme.
 *
 * @package Wpts
...
add_filter( 'woocommerce_style_smallscreen_breakpoint', 'wpts_woocommerce_breakpoint' );
/**
 ...
 */
function wpts_woocommerce_breakpoint() {
...
add_filter( 'genesiswooc_products_per_page', 'wpts_default_products_per_page' );
/**
 ...
 */
function wpts_default_products_per_page() {

	return 8;

}

add_filter( 'woocommerce_pagination_args', 'wpts_woocommerce_pagination' );
/**
 ...
 */
function wpts_woocommerce_pagination( $args ) {

	$args['prev_text'] = sprintf( '&laquo; %s', __( 'Previous Page', 'wpts' ) );
	$args['next_text'] = sprintf( '%s &raquo;', __( 'Next Page', 'wpts' ) );

	return $args;

}

add_action( 'after_switch_theme', 'wpts_woocommerce_image_dimensions_after_theme_setup', 1 );
/**
 * Defines WooCommerce image sizes on theme activation.
 *
 * @since 2.3.0
 */
function wpts_woocommerce_image_dimensions_after_theme_setup() {
	...
	wpts_update_woocommerce_image_dimensions();

}

add_action( 'activated_plugin', 'wpts_woocommerce_image_dimensions_after_woo_activation', 10, 2 );
/**
 ...
 */
function wpts_woocommerce_image_dimensions_after_woo_activation( $plugin ) {
 ...
 * @since 2.3.0
 */
function wpts_update_woocommerce_image_dimensions() {
...
add_filter( 'woocommerce_get_image_size_gallery_thumbnail', 'wpts_gallery_image_thumbnail' );
/**
 ...
 */
function wpts_gallery_image_thumbnail( $size ) {
