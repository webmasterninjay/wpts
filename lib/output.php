 ...
 * Wpts.
 *
 * This file adds the required CSS to the front end to the Wpts Theme.
 *
 * @package Wpts
...
add_action( 'wp_enqueue_scripts', 'wpts_css' );
/**
...
function wpts_css() {
	...
	if ( $logo ) {
		...
		$logo_max_width        = get_theme_mod( 'wpts_logo_width', 350 );
