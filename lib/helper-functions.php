 ...
 * Wpts.
 *
 * This file adds the required helper functions used in the Wpts Theme.
 *
 * @package Wpts
 ...
 */
function wpts_color_contrast( $color ) {
	...
	return ( $luminosity > 128 ) ? '#000333' : '#ffffff';
 ...
 */
function wpts_color_brightness( $color, $change ) {
